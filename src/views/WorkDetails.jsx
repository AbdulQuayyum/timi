...
const ContentRenderer = ({ subcontent, index }) => {
...
const WorkDetailsPage = () => {
    ...
    if (!work) {
        return (
            <>
                <SEOHelmet title="Work Not Found (404) | Timi's Portfolio" description="We couldn't find the specific project case study you were looking for. Explore Timi's other featured work." />
                <motion.div
                ...
                >
                    ...
                    <motion.p
                        className="mb-5 text-[#666] text-xl"
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.3 }}
                    >
                        It looks like the case study for the project ID "{id}" doesn't exist, or the link may have changed.
                    </motion.p>
                    <motion.p
                        className="mb-[30px]"
                        initial={{ opacity: 0, y: 10 }}
                    ...
                    >
                        Don't worry, you can still find some great stuff!
                    </motion.p>
                    ...
                    >
                        <Link to={routes.work}>
                            <motion.button
                                className="bg-[#FF0000] w-full max-w-md cursor-pointer text-white font-medium flex items-center justify-center rounded-full h-[51px] px-6"
                    ...
                    >
                        <Link to={routes.home}>
                            <motion.button
                                className="border border-[#FF0000] w-full max-w-md cursor-pointer text-[#FF0000] font-medium flex items-center justify-center rounded-full h-[51px] px-6"
    ...
    return (
        <>
            <SEOHelmet title={`${work.name} Case Study | Timi`} description={work.shortDescription} keywords={work.keywords || pageSEO.keywords} canonical={`/work/${work.id}`} />
                ...
                >
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            whileHover={{ scale: 1.05 }}
                        >
                            <span className="text-[#383838] text-base font-medium font-ppnm">Photography</span>
                    ...
                    {work.content.map((item, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <ContentRenderer subcontent={item.subcontent} index={index} />
                            </motion.div>
                        </motion.div>
                    ))}
                </div>
