    ...
    return (
        <>
            ...
            <section className="flex items-center justify-center flex-col pt-12 pb-20 px-4 w-full">
                ...
                >
                    <motion.div 
                        className="w-full flex items-center justify-center shrink-0 rounded-2xl overflow-hidden bg-white max-w-[422px]"
                            ...
                            >
                                ...
                                >
                                    {item.item.map((subitem, subindex) => (
                                        ...
                                        >
                                            <div className="flex items-center justify-center rounded-full h-[38px] w-[38px] bg-white">
                                            </div>
